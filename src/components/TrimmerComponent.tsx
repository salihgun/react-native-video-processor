...
import type { ITrimmerComponentProps } from './types';

const { width, height } = Dimensions.get('window');

export class TrimmerComponent extends React.Component<ITrimmerComponentProps> {
  videoPlayerRef = React.createRef<Video>();
  state = {
    progress: -1,
  };

  public roundedDuration = Math.round(this.props.duration);

  componentDidUpdate(prevProps: ITrimmerComponentProps) {
