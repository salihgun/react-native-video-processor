...
import type { FrameSliderPropTypes, FrameSliderState, Element } from './types';

const itemAmountPerScreen = 10;

export class FrameSlider extends React.Component<
  FrameSliderPropTypes,
  FrameSliderState
> {
  ...
  constructor(props: FrameSliderPropTypes) {
    super(props);
    this.state = {
  ...
  override shouldComponentUpdate(
    nextProps: Readonly<FrameSliderPropTypes>,
    nextState: Readonly<FrameSliderState>
  ): boolean {
  ...
  renderDefaultThumb = () => <Marker thumbStyle={this.props.thumbStyle} />;
